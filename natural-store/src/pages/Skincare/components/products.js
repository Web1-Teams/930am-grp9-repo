    ...
    <div className="all-product">
        <div className="product-grid">
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/serum_bottle_mockup.png" alt="Product 1"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/226.png" alt="Product 2"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/herbal facial.PNG" alt="Product 3"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/nourishing.png" alt="Product 4"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/315.png" alt="Product 5"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/90697fgjgj_93.png" alt="Product 6"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/10571486.png" alt="Product 7"/>
            ...
            <div className="product-card">
                <img className="product-image" src="/assets/liquid_bottle_mockup.png" alt="Product 8"/>
